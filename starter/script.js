...
console.log(maskCreditCard(4337846));
...
// using replaceAll changes all of the occurences
...
for (const [i] of scoringPlayers.entries()) {
  console.log(`Goal ${i + 1}: ${scoringPlayers[i]} `);
}
